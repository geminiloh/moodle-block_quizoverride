...
/**
 * The task that provides a complete restore of block_quizoverride is defined here.
 *
...
require_once($CFG->dirroot.'//blocks/quizoverride/backup/moodle2/restore_quizoverride_stepslib.php');

/**
 * Restore task for block_quizoverride.
 */
class restore_quizoverride_block_task extends restore_block_task {
