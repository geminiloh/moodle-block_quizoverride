...
require_once($CFG->dirroot.'//blocks/quizoverride/backup/moodle2/backup_quizoverride_stepslib.php');
require_once($CFG->dirroot.'//blocks/quizoverride/backup/moodle2/backup_quizoverride_settingslib.php');

/**
 * The class provides all the settings and steps to perform one complete backup
 * of block_quizoverride.
 */
class backup_quizoverride_block_task extends backup_block_task {
